...
export const mockScenes: Scene[] = [
  {
    ...
    name: "智慧医疗数据分析",
    domain: "医疗健康",
    description: "基于多方数据的智能分析模型",
    validFrom: "2026-04-01",
    validTo: "2026-12-31",
    productName: "智能分析API",
    productForm: "api",
    productDesc: "提供数据风险评分API接口",
    devMethod: "privacy",
    samplingReq: "随机抽样5000条，分层抽样确保正负样本比例1:3",
    maskingRules: "姓名掩码，证件号泛化，手机号扰动",
    status: "active",
    currentStep: 5,
    createdBy: "科技公司甲",
  ...
  },
  {
    ...
    name: "金融风控联合建模",
    domain: "金融服务",
    description: "多源数据联合风控建模场景",
    validFrom: "2026-03-01",
    validTo: "2026-09-30",
    productName: "联合建模产品",
    productForm: "service",
    productDesc: "多源数据联合分析服务",
    devMethod: "privacy",
    samplingReq: "系统抽样10000条，覆盖所有年龄段",
    maskingRules: "证件号掩码，账号泛化",
    status: "active",
    currentStep: 5,
    createdBy: "科技公司甲",
  ...
  },
  {
    ...
    name: "信贷数据分析",
    domain: "金融服务",
    description: "信贷业务数据分析场景",
    validFrom: "2026-05-01",
    validTo: "2026-11-30",
    productName: "信贷分析API",
    productForm: "api",
    productDesc: "信贷业务数据查询API",
    devMethod: "secret",
    samplingReq: "随机抽样8000条",
    maskingRules: "证件号掩码，单位名称泛化",
    status: "draft",
    currentStep: 2,
    createdBy: "智能科技丙",
