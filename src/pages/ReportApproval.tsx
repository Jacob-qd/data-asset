...
const items = [
  { id: "RP-001", name: "Q1隐私计算报告", project: "金融风控", author: "张三", status: "待审批", time: "2026-04-24" },
  { id: "RP-002", name: "模型评估报告", project: "医疗诊断", author: "李四", status: "已通过", time: "2026-04-23" },
];
    ...
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem><BreadcrumbLink>报告审批</BreadcrumbLink></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <h1 className="text-2xl font-bold text-gray-900 tracking-tight">报告审批</h1>
      ...
      <Card className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <CardContent>
          <Table className="unified-table">
            <TableHeader>
              <TableRow>
                <TableHead>单号</TableHead><TableHead>报告名称</TableHead><TableHead>所属项目</TableHead><TableHead>作者</TableHead><TableHead>状态</TableHead><TableHead>操作</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map(i => (
