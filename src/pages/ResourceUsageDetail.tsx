...
export default function ResourceUsageDetail() {
    ...
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem><BreadcrumbLink>用量明细</BreadcrumbLink></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">用量明细</h1>
          <p className="text-sm text-gray-500 mt-1.5">资源使用明细与统计分析</p>
        </div>
        <Dialog>
          ...
          <DialogContent className="sm:max-w-lg rounded-xl border-0 shadow-2xl">
            <DialogHeader><DialogTitle>新建用量明细</DialogTitle></DialogHeader>
