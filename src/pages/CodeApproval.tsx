...
const items = [
  { id: "CD-001", name: "联邦XGBoost优化版", author: "张三", reviewer: "李四", status: "待审批", submitTime: "2026-04-24" },
  { id: "CD-002", name: "差分隐私均值算法", author: "王五", reviewer: "赵六", status: "已通过", submitTime: "2026-04-23" },
];

export default function CodeApproval() {
    ...
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem><BreadcrumbLink>代码审批</BreadcrumbLink></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <h1 className="text-2xl font-bold text-gray-900 tracking-tight">代码审批</h1>
      ...
      <Card className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <CardContent>
          <Table className="unified-table">
            <TableHeader>
              <TableRow>
                <TableHead>单号</TableHead><TableHead>代码名称</TableHead><TableHead>作者</TableHead><TableHead>审核人</TableHead><TableHead>状态</TableHead><TableHead>操作</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map(i => (
                <TableRow key={i.id}>
                  ...
                  <TableCell>{i.reviewer}</TableCell>
