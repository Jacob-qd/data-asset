...
const data = [
  { id: "P3-FED-001", name: "示例项A", status: "进行中", time: "2026-04-24" },
  { id: "P3-FED-002", name: "示例项B", status: "已完成", time: "2026-04-23" },
  { id: "P3-FED-003", name: "示例项C", status: "待执行", time: "2026-04-22" },
];
    ...
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem><BreadcrumbLink>联邦预测</BreadcrumbLink></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">联邦预测</h1>
          <p className="text-sm text-gray-500 mt-1.5">联邦学习模型预测任务</p>
        </div>
        <Dialog>
          ...
          <DialogContent className="sm:max-w-lg rounded-xl border-0 shadow-2xl">
            <DialogHeader><DialogTitle>新建联邦预测</DialogTitle></DialogHeader>
