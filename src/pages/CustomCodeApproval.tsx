...
export default function CustomCodeApproval() {
    ...
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem><BreadcrumbLink>自定义代码审批</BreadcrumbLink></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">自定义代码审批</h1>
          <p className="text-sm text-gray-500 mt-1.5">用户自定义算法代码审批</p>
        </div>
        <Dialog>
          ...
          <DialogContent className="sm:max-w-lg rounded-xl border-0 shadow-2xl">
            <DialogHeader><DialogTitle>新建自定义代码审批</DialogTitle></DialogHeader>
