  ...
  return (
    <div className="p-6 space-y-6 max-w-[1440px] mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">脱敏规则</h1>
          <p className="text-sm text-gray-500 mt-1.5">数据脱敏规则配置管理</p>
        </div>
        <Dialog>
          ...
          <DialogContent className="sm:max-w-lg rounded-xl border-0 shadow-2xl">
            <DialogHeader><DialogTitle>新建脱敏规则</DialogTitle></DialogHeader>
